...
def test_read_main():
    ...
    assert response.json() == {"message": "Test stanu API zakończony sukcesem"}
...
#Test punktu końcowego /v0/performances/ ze zmianą daty
...
#Test punktu końcowego /v0/teams/
def test_read_teams():
